  ...
  <section id="snippet-2" class="wrapper bg-light wrapper-border">
    <div class="container pt-15 pt-md-17">
      ...
      <p class="lead mb-0">
        ...
        <router-link to="/demo3" class="external">Demo 3</router-link>
        or
        <router-link to="/demo15" class="external">Demo 15</router-link>.
      </p>
    </div>
    <!-- /.container -->
    <div
      ...
      <div class="card">
        <div class="card-footer border-0 position-relative">
          <a
            ...
            href="#collapse-snippet-212"
            >View example's code</a
          >
        </div>
        <!--/.card-footer -->
        <div
          id="collapse-snippet-212"
