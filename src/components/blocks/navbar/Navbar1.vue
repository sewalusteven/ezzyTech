  ...
  <section id="snippet-1" class="wrapper bg-light wrapper-border">
    <div class="container pt-12">
      ...
      <p class="lead mb-0">
        ...
        <router-link to="/demo1" class="external">Demo 1</router-link>
        or
        <router-link to="/demo4" class="external">Demo 4</router-link>.
      </p>
    </div>
    <!-- /.container -->
      ...
      <div class="card">
        <div class="card-footer border-0 position-relative">
          <a
            ...
            href="#collapse-snippet-210"
            >View example's code</a
          >
        </div>
        <!--/.card-footer -->
        <div
          id="collapse-snippet-210"
