  ...
  <section id="snippet-6" class="wrapper bg-light wrapper-border">
    <div class="container pt-15 pt-md-17">
      ...
      <p class="lead mb-0">
        ...
        <router-link to="/demo6" class="external">Demo 6</router-link>
        or
        <router-link to="/demo8" class="external">Demo 8</router-link>.
      </p>
    </div>
    <!-- /.container -->
      ...
      <div class="card">
        <div class="card-footer border-0 position-relative">
          <a
            ...
            href="#collapse-snippet-216"
            >View example's code</a
          >
        </div>
        <!--/.card-footer -->
        <div
          id="collapse-snippet-216"
