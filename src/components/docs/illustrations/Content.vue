          ...
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                ...
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i1.png" srcset="./assets/img/illustrations/i1@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i2.png" srcset="./assets/img/illustrations/i2@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i3.png" srcset="./assets/img/illustrations/i3@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i4.png" srcset="./assets/img/illustrations/i4@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i5.png" srcset="./assets/img/illustrations/i5@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i6.png" srcset="./assets/img/illustrations/i6@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i7.png" srcset="./assets/img/illustrations/i7@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i8.png" srcset="./assets/img/illustrations/i8@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i9.png" srcset="./assets/img/illustrations/i9@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i10.png" srcset="./assets/img/illustrations/i10@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i11.png" srcset="./assets/img/illustrations/i11@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i12.png" srcset="./assets/img/illustrations/i12@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i13.png" srcset="./assets/img/illustrations/i13@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i14.png" srcset="./assets/img/illustrations/i14@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i15.png" srcset="./assets/img/illustrations/i15@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i16.png" srcset="./assets/img/illustrations/i16@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i17.png" srcset="./assets/img/illustrations/i17@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i18.png" srcset="./assets/img/illustrations/i18@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i19.png" srcset="./assets/img/illustrations/i19@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i20.png" srcset="./assets/img/illustrations/i20@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i21.png" srcset="./assets/img/illustrations/i21@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i22.png" srcset="./assets/img/illustrations/i22@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i23.png" srcset="./assets/img/illustrations/i23@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i24.png" srcset="./assets/img/illustrations/i24@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i25.png" srcset="./assets/img/illustrations/i25@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i26.png" srcset="./assets/img/illustrations/i26@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i27.png" srcset="./assets/img/illustrations/i27@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/ui1.png" srcset="./assets/img/illustrations/ui1@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/ui2.png" srcset="./assets/img/illustrations/ui2@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/ui3.png" srcset="./assets/img/illustrations/ui3@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/ui4.png" srcset="./assets/img/illustrations/ui4@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/ui5.png" srcset="./assets/img/illustrations/ui5@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/3d1.png" srcset="./assets/img/illustrations/3d1@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/3d2.png" srcset="./assets/img/illustrations/3d2@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/3d3.png" srcset="./assets/img/illustrations/3d3@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/3d4.png" srcset="./assets/img/illustrations/3d4@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/3d5.png" srcset="./assets/img/illustrations/3d5@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/3d6.png" srcset="./assets/img/illustrations/3d6@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/3d7.png" srcset="./assets/img/illustrations/3d7@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/3d8.png" srcset="./assets/img/illustrations/3d8@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/3d9.png" srcset="./assets/img/illustrations/3d9@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/3d10.png" srcset="./assets/img/illustrations/3d10@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/3d11.png" srcset="./assets/img/illustrations/3d11@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/3d12.png" srcset="./assets/img/illustrations/3d12@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i28.png" srcset="./assets/img/illustrations/i28@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i29.png" srcset="./assets/img/illustrations/i29@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i30.png" srcset="./assets/img/illustrations/i30@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i31.png" srcset="./assets/img/illustrations/i31@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/i32.png" srcset="./assets/img/illustrations/i32@2x.png 2x" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 col-md-4 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/ni1.png" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 col-md-4 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/ni2.png" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 col-md-4 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/ni3.png" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 col-md-4 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/ni4.png" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 col-md-4 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/ni5.png" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 col-md-4 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/ni6.png" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 col-md-4 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/ni7.png" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 col-md-4 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/ni8.png" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
        ...
        <li class="col-6 col-md-4 text-center">
          <div class="card h-100">
            ...
            <div class="card-footer position-relative">
              <a
                class="stretched-link link-body btn-copy-icon"
                data-clipboard-text='&lt;img class="img-fluid" src="./assets/img/illustrations/ni9.png" alt="photo" /&gt;'
                >Copy</a
              >
            </div>
          </div>
