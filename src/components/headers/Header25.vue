...
import HeadersComponentsLinks from "@/components/headers/components/Links.vue";

import HeadersComponentsSocials from "@/components/headers/components/Socials.vue";

import HeadersComponentsSocials4 from "@/components/headers/components/Socials4.vue";
const navLinks = ref([
  { text: "Home", href: "#home" },
